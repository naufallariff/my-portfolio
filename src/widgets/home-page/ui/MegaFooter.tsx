    ...
    return (
        <footer className="border-t border-(--color-border) mt-24" id="contact">
            <div className="py-16 md:py-24 text-center">
                ...
                <a href={`mailto:${contactConfig.email}`} className="btn-primary text-lg px-8 py-4">Get in Touch</a>
            </div>
                    ...
                    <div>
                        ...
                        <ul className="space-y-2">
                            {['Home', 'Projects', 'Digital Garden'].map((link) => (
                                <li key={link}><a href={link === 'Home' ? '/' : `#`} className="text-sm text-(--color-text-secondary) hover:text-(--color-accent) transition-colors">{link}</a></li>
                            ))}
                        </ul>
                    </div>
                    <div>
                        ...
                        <div className="flex gap-3">
                            <a href={contactConfig.github} target="_blank" rel="noopener noreferrer" className="btn-secondary p-3" aria-label="GitHub">
                            ...
                            <a href={contactConfig.linkedin} target="_blank" rel="noopener noreferrer" className="btn-secondary p-3" aria-label="LinkedIn">
